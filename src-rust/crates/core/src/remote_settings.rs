...
// ~/.asimov/remote-settings.json, and polls every hour in the background.
...
/// On-disk cache structure stored in ~/.asimov/remote-settings.json.
...
/// Return the ~/.asimov directory, falling back to the current directory.
