// session_storage.rs — JSONL transcript persistence for Asimov.
//
// File layout:  ~/.asimov/projects/{base64url(project_root)}/{session_id}.jsonl
//
...
pub struct TranscriptMessage {
    ...
    /// Version of the Asimov binary, mirrors `MACRO.VERSION`.
    #[serde(default)]
    pub version: String,
...
/// Returns the base projects directory: `~/.asimov/projects/`.
