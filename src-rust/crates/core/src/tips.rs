// tips.rs — Tip scheduling system for Asimov.
//
// Ported from:
...
//
// Tips are shown during the spinner while Asimov is processing.  Each tip has
// a `cooldown_sessions` field — the tip won't be shown again until that many
// sessions have passed since the last display.
//
// History is persisted to `~/.asimov/tip_history.json`.
...
static ALL_TIPS: Lazy<Vec<Tip>> = Lazy::new(|| {
    vec![
        Tip {
            id: "new-user-warmup",
            content: "Start with small features or bug fixes, tell Asimov to propose a plan, and verify its suggested edits",
            cooldown_sessions: 3,
        },
        Tip {
        ...
        Tip {
            id: "git-worktrees",
            content: "Use git worktrees to run multiple Asimov sessions in parallel.",
            cooldown_sessions: 10,
        },
        Tip {
            id: "color-when-multi-clauding",
            content: "Running multiple Asimov sessions? Use /color and /rename to tell them apart at a glance.",
            cooldown_sessions: 10,
        },
        Tip {
            id: "shift-enter",
        ...
        Tip {
            id: "memory-command",
            content: "Use /memory to view and manage Asimov memory",
        ...
        Tip {
            id: "prompt-queue",
            content: "Hit Enter to queue up additional messages while Asimov is working.",
            cooldown_sessions: 5,
        },
        Tip {
            id: "enter-to-steer-in-realtime",
            content: "Send messages to Asimov while it works to steer Asimov in real-time",
            cooldown_sessions: 20,
        },
        Tip {
            id: "todo-list",
            content: "Ask Asimov to create a todo list when working on complex tasks to track progress and remain on track",
            cooldown_sessions: 20,
        },
        Tip {
            id: "permissions",
        ...
        Tip {
            id: "custom-commands",
            content: "Create skills by adding .md files to .asimov/skills/ in your project or ~/.asimov/skills/ for skills that work in any project",
            cooldown_sessions: 15,
        },
        Tip {
            id: "shift-tab",
...
impl TipHistory {
    /// Path to the persisted history file: `~/.asimov/tip_history.json`.
    fn history_path() -> Option<std::path::PathBuf> {
        dirs::home_dir().map(|h| h.join(".asimov").join("tip_history.json"))
    }

    /// Load history from `~/.asimov/tip_history.json`.
    ...
    /// Persist history to `~/.asimov/tip_history.json`.
